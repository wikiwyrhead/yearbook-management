 ...
 */
import { DesignProviderNotConfiguredError, } from "./design-provider";
const CANVA_API = "https://api.canva.com/rest/v1";
function token(ref) {
    if (ref.accessToken)
        return ref.accessToken;
    throw new DesignProviderNotConfiguredError("canva", "this yearbook has no authorized Canva connection");
}
async function canvaFetch(ref, path, init) {
